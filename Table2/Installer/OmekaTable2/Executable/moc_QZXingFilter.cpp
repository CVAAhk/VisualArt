...
#include "../../OmekaTable2/qzxing/QZXingFilter.h"
...
void QZXingFilter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QZXingFilter::isDecodingChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QZXingFilter::decodingFinished)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QZXingFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QZXingFilter::decodingStarted)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QZXingFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QZXingFilter::captureRectChanged)) {
                *result = 3;
                return;
            }
        }
