package com.gestureworks.cml.components 
{
	...
	{
		protected var streamOps:RegExp = /(play|pause|stop|resume|seek|volume|pan)$/i;  
		protected var streamControls:Array
		 ...
		 */
		protected function storeStreamControls():void {
		...
		override public function updateLayout():void {
			for each(var control:Sprite in streamControls) {
