...
{	
	...
	public class DisplayUtils 
	{
		...
		/**
		 * Extracts rotation from provided transfromation matrix
		 * @param	matrix
		 * @return
		 */
		public static function rotationFromMatrix(matrix:Matrix):Number {
			var mtx:Matrix = matrix.clone();						
			var translate:Point;
			
			//extract translation
			var p:Point = new Point();
			translate = mtx.transformPoint(p);
			mtx.translate( -translate.x, -translate.y);
