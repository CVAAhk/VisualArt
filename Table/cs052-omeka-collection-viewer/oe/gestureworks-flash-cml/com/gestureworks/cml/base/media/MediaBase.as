package com.gestureworks.cml.base.media 
{
	...
	public class MediaBase extends TouchContainer
	{
		...
		/**
		 * Media object is automatically resampled relative to width when file exceeds thid boundary
		 */		
		...
		/**
		 * Media object is automatically resampled relative to height when file exceeds thid boundary
		 */		
