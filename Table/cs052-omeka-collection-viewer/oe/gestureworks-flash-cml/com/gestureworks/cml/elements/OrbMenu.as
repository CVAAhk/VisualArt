	...
	public class OrbMenu extends Menu
	{
		...
		*/
		...
		private function tween():void
		{
			if (attractMode)
			{
				tweener = TweenLite.to(this, 40, { x: NumberUtils.instance.randomNumber(0, (stage.stageWidth - orbRadius)), y: NumberUtils.instance.randomNumber(0, (stage.stageHeight - orbRadius)), ease:Elastic.easeOut, onComplete:tween } );
				tweener.play();
			}
		}
