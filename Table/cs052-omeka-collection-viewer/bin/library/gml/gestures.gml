...
<GestureMarkupLanguage xmlns:gml="http://gestureworks.com/gml/version/1.0" key="cl3ar">
	...
	<Gesture_set id="special-manipulations">		
									...
									<Gesture id="n-finger-pivot-inertia" type="pivot">
										<match>
											<action>
												<initial>
													<cluster point_number="0" point_number_min="1" point_number_max="10"/>
										...
										<analysis>
											<algorithm class="kinemetric" type="continuous">
												...
												<returns>
													...
													<property id="orient_hand" result="handednes"/>
	...
	<Gesture_set id="n-timeline">
		...
		<Gesture_set id="touch-3d-manipulations">
