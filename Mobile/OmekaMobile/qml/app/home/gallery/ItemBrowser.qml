...
Browser {
    ...
    property int pageCount: layout.model ? layout.model.count / Omeka.resultsPerPage : 0
    ...
    property int rowCount: Math.ceil((Omeka.resultsPerPage*pageCount)/columnCount)
